...
if ($r2.Output -match "message_deletions") {
    ...
    if ($r3.Output -match "online") {
        Write-Host "DONE - Test the website now" -ForegroundColor Green
    }
} else {
    Write-Host "FAILED" -ForegroundColor Red
}
