...
router.post('/', async (req, res) => {
    try {
        const { student_name, phone, grade_id, grade_name, group_id, group_name, amount, notes, receipt_image_url } = req.body;
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending')`, [requestId, student_name, phone, grade_id || null, grade_name || null, group_id || null, group_name || null, amount || null, notes || null, receipt_image_url || null]);
        res.status(201).json({
