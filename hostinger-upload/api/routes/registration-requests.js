...
router.post('/:id/approve', authenticateToken, requireAdmin, async (req, res) => {
    ...
    try {
        ...
        await connection.query(`INSERT INTO students (id, name, phone, grade_id, group_id, password_hash, approval_status, is_offline, created_at) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())`, [studentId, request.name, request.phone, request.grade_id, request.group_id, request.password_hash, 'approved', request.is_offline || false]);
